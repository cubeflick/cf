...
$.include('coin-slider.js')
$(function(){
	if($('.fixedtip').length||$('.clicktip').length||$('.normaltip').length)$.include('jquery.atooltip.pack.js')
	if($('#contact-form').length)$.include('forms.js')
	if($('.maxheight').length)$.include('jquery.equalheights.js')
	if($('.top1').length||$('.layouts-nav li a').length)$.include('scrollTop.js')
	if($('.kwicks').length)$.include('kwicks-1.5.1.pack.js')
	if($("#thumbs").length)$.include('jquery.galleriffic.js')
	if($(".lightbox-image").length)$.include('jquery.prettyPhoto.js')
	if($("#twitter").length)$.include('jquery.twitter.js')
	if($('#countdown_dashboard').length)$.include('jquery.lwtCountdown-1.0.js')
