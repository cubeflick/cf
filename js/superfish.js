	...
	.hover(
		...
		function(){
			if($(this).hasClass('sfHover'))return
				...
				$(this).find('>span').stop().animate({height:0,top:49,left:'50%',width:0})
			}
		}
	)
})